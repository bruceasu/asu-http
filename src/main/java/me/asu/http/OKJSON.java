...
public class OKJSON {
    ...
    private static ThreadLocal<OkJsonParser>    okjsonParserCache  = new ThreadLocal<OkJsonParser>();;
    ...
    private static synchronized OkJsonParser getOkJsonParser() {
        OkJsonParser okjsonParser;
        // It is impossible for it to be empty.
...
class OkJsonParser {
    ...
    private int stringToArrayObject(char[] jsonCharArray, Object object, Field field) {
        ...
        while (true) {
            ...
            } else if (tokenType == TokenType.TOKEN_TYPE_STRING || tokenType == TokenType.TOKEN_TYPE_INTEGER ||
                    tokenType == TokenType.TOKEN_TYPE_DECIMAL || tokenType == TokenType.TOKEN_TYPE_BOOL) {
                ;
            } else {
    ...
    private int setObjectProperty(char[] jsonCharArray, TokenType valueTokenType, int valueBeginOffset, int valueEndOffset, Object object, Field field, Method method) {
        ...
        if (field.getType() == String.class) {
            ...
            try {
                long value = Long.valueOf(new String(jsonCharArray, valueBeginOffset,
                        valueEndOffset - valueBeginOffset + 1)).longValue();
                if (method != null) {
                    method.invoke(object, value);
                } else if (directAccessPropertyEnable == true) {
    ...
    private int stringToObjectProperties(char[] jsonCharArray, Object object) {
        ...
        while (true) {
            ...
            if (tokenType != TokenType.TOKEN_TYPE_STRING) {
                errorDesc = "expect a name but \"" +
                        String.copyValueOf(jsonCharArray, beginOffset, endOffset - beginOffset + 1) + "\"";
        ...
        if (classFieldList.isEmpty()) {
            ...
            for (Field f : fields) {
                ...
                if (f.getType() == String.class)
                    ...
                    classField.type = ClassFieldType.CLASSFILEDTYPE_ENUM;
                } else
                    classField.type = ClassFieldType.CLASSFIELDTYPE_SUBCLASS;

                try {
                    if (f.getType() == Boolean.class || f.getType().getName().equals("boolean")) {
                        methodName = "is" + f.getName().substring(0, 1).toUpperCase(Locale.getDefault()) +
                                f.getName().substring(1);
                    } else {
                        methodName = "get" + f.getName().substring(0, 1).toUpperCase(Locale.getDefault()) +
                                f.getName().substring(1);
                    }
        ...
        for (OkJsonClassField classField : classFieldList) {
            ...
            switch (classField.type) {
                case CLASSFIELDTYPE_STRING:
                    ...
                    if (string != null) {
                        if (prettyFormatEnable) {
                            jsonCharArrayBuilder.appendTabs(
                                    depth + 1).appendJsonNameAndColonAndQmStringQmPretty(classField.fieldName, string);
                        } else {
                        ...
                        if (prettyFormatEnable) {
                            jsonCharArrayBuilder.appendTabs(
                                    depth + 1).appendJsonNameAndColonAndStringPretty(classField.fieldName, NULL_STRING);
                        } else {
                    ...
                    if (value != null) {
                        if (prettyFormatEnable) {
                            jsonCharArrayBuilder.appendTabs(depth +
                                    1).appendJsonNameAndColonAndStringPretty(classField.fieldName, value.toString());
                        } else {
                ...
                case CLASSFIELDTYPE_LOCALDATE:
                    ...
                    if (localDate != null) {
                        ...
                        if (localDateString != null) {
                            if (prettyFormatEnable) {
                                jsonCharArrayBuilder.appendTabs(depth +
                                        1).appendJsonNameAndColonAndQmStringQmPretty(classField.fieldName, localDateString);
                            } else {
                            ...
                            if (prettyFormatEnable) {
                                jsonCharArrayBuilder.appendTabs(depth +
                                        1).appendJsonNameAndColonAndStringPretty(classField.fieldName, NULL_STRING);
                            } else {
                                jsonCharArrayBuilder.appendJsonNameAndColonAndString(classField.fieldName, NULL_STRING);
                            }
                        }
                ...
                case CLASSFIELDTYPE_LOCALTIME:
                    ...
                    if (localTime != null) {
                        ...
                        if (localTimeString != null) {
                            if (prettyFormatEnable) {
                                jsonCharArrayBuilder.appendTabs(depth +
                                        1).appendJsonNameAndColonAndQmStringQmPretty(classField.fieldName, localTimeString);
                            } else {
                ...
                case CLASSFIELDTYPE_LOCALDATETIME:
                    ...
                    if (localDateTime != null) {
                        ...
                        if (localDateTimeString != null) {
                            if (prettyFormatEnable) {
                                jsonCharArrayBuilder.appendTabs(depth +
                                        1).appendJsonNameAndColonAndQmStringQmPretty(classField.fieldName, localDateTimeString);
                            } else {
                ...
                case CLASSFIELDTYPE_LIST:
                    ...
                    if (array != null) {
                        ...
                        if (arrayCount > 0) {
                            if (prettyFormatEnable) {
                                jsonCharArrayBuilder.appendTabs(
                                        depth + 1).appendJsonNameAndColonAndOpenBytePretty(classField.fieldName, '[');
                                nret = objectToListString(array, arrayCount, classField, jsonCharArrayBuilder,
                                        depth + 1);
                                if (nret != 0)
                                    return nret;
                ...
                case CLASSFIELDTYPE_SUBCLASS:
                    ...
                    break;
                case CLASSFILEDTYPE_ENUM:
                    Enum enumObject;
                    if (classField.getMethod != null) {
                        try {
                            enumObject = (Enum) classField.getMethod.invoke(object);
                        } catch (Exception e) {
                            e.printStackTrace();
                            return OKJSON_ERROR_EXCEPTION;
                        }
                        ...
                        try {
                            enumObject = (Enum) classField.field.get(object);
                        } catch (Exception e) {
                            e.printStackTrace();
                            return OKJSON_ERROR_EXCEPTION;
                        }
                    ...
                    if (enumObject != null) {
                        jsonCharArrayBuilder.appendJsonNameAndColonAndQmStringQm(classField.fieldName, enumObject.name());
                    } else {
                        jsonCharArrayBuilder.appendJsonNameAndColonAndString(classField.fieldName, NULL_STRING);
                    }
                    break;
